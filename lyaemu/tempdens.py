...
def mean_density(hub, redshift, unit=units.UnitSystem(), omegab=0.0465):
...
def get_median_temp(num, base):
    """Get the median temperature between 0.95 and 1.05 x mean cosmic baryon density.
    Arguments:
        num - snapshot number
