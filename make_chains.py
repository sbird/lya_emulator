...
if args.quadratic:
    ...
    like = LikelihoodClass(basedir=os.path.expanduser("simulations/hires_s8_quadratic"), emulator_class="quadratic",t0_training_value=args.t0 )
else:
    savefile = os.path.join("simulations/hires_s8", savefile)
    like = LikelihoodClass(basedir=os.path.join("simulations/hires_s8"), t0_training_value=args.t0)
